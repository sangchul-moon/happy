...
export const pt: TranslationStructure = {
    ...
    files: {
        ...
        deleteConfirmMessage: ({ name }: { name: string }) => `Tem certeza de que deseja excluir "${name}"? Esta ação não pode ser desfeita.`,
        createFileSuccess: 'Arquivo criado com sucesso',
