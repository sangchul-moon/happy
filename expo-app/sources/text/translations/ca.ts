...
export const ca: TranslationStructure = {
    ...
    files: {
        ...
        enterFolderName: 'Introdueix el nom de la carpeta',
        enterNewName: 'Introdueix el nou nom',
        create: 'Crear',
        cancel: 'Cancel·lar',
        confirm: 'Confirmar',
        deleteConfirmTitle: 'Eliminar',
        deleteConfirmMessage: ({ name }: { name: string }) => `Estàs segur que vols eliminar "${name}"? Aquesta acció no es pot desfer.`,
        createFileSuccess: 'Fitxer creat correctament',
        createFolderSuccess: 'Carpeta creada correctament',
        renameSuccess: 'Canvi de nom realitzat correctament',
        deleteSuccess: 'Eliminat correctament',
        operationFailed: 'Operació fallida',
        fileActions: 'Accions de fitxer',
        folder: 'Carpeta',
        ...
        downloadSuccess: 'Fitxer descarregat correctament',
    },
