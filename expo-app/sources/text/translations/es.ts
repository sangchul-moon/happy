...
export const es: TranslationStructure = {
    ...
    files: {
        ...
        deleteConfirmMessage: ({ name }: { name: string }) => `¿Está seguro de que desea eliminar "${name}"? Esta acción no se puede deshacer.`,
        createFileSuccess: 'Archivo creado correctamente',
        createFolderSuccess: 'Carpeta creada correctamente',
