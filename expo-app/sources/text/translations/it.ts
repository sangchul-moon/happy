...
export const it: TranslationStructure = {
    ...
    files: {
        ...
        deleteConfirmMessage: ({ name }: { name: string }) => `Sei sicuro di voler eliminare "${name}"? Questa azione non può essere annullata.`,
        createFileSuccess: 'File creato con successo',
