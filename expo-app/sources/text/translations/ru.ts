...
export const ru: TranslationStructure = {
    ...
    files: {
        ...
        deleteConfirmMessage: ({ name }: { name: string }) => `Вы уверены, что хотите удалить "${name}"? Это действие нельзя отменить.`,
        createFileSuccess: 'Файл создан успешно',
        ...
        download: 'Скачать',
        downloadSuccess: 'Файл скачан успешно',
    },
