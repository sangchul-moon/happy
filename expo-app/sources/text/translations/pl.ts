...
export const pl: TranslationStructure = {
    ...
    files: {
        ...
        deleteConfirmMessage: ({ name }: { name: string }) => `Czy na pewno chcesz usunąć "${name}"? Tej akcji nie można cofnąć.`,
        createFileSuccess: 'Plik utworzony pomyślnie',
        createFolderSuccess: 'Folder utworzony pomyślnie',
        renameSuccess: 'Zmieniono nazwę pomyślnie',
        deleteSuccess: 'Usunięto pomyślnie',
        operationFailed: 'Operacja nie powiodła się',
        fileActions: 'Akcje pliku',
        folder: 'Folder',
